            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-register-image"
                        style="background-image: url('<?= base_url('assets/'); ?>');"
                    ></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="<?= base_url('/register/store'); ?>" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="name"
                                            placeholder="Your Name" required value="<?= set_value('name'); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            id="password" placeholder="Password" required value="<?= set_value('password'); ?>">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                ...
                                <hr>
                                <a href="index.html" class="btn btn-google btn-user btn-block" style="">
                                    <i class="fab fa-google fa-fw"></i> Register with Google
                                </a>
                                <a href="index.html" class="btn btn-facebook btn-user btn-block" style="">
